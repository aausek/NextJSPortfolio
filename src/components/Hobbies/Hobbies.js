...
const Hobbies = () => {
  ...
  myHeaders.append("Authorization", "Bearer eyJhcGlfa2V5IjoiSXdOZmJZR1JDUVk5TGhBRHl0a3dYbXEzV2RRVHA5MnQ2ZTJQZlpRekRscz0ifQ==");
  ...
  const epIndex = () => {
    ...
    useEffect(() => {
      setLoading(true)
      fetch("https://api.simplecast.com/podcasts/a6a073bf-00c1-4368-9f72-f4589880b5de/episodes", requestOptions)
        .then((res) => res.json())
        .then((data) => {
          ...
          <IframeSection>
            <SectionDivider/>
              <SectionTitle main>Hobbies</SectionTitle>
                ...
                {/* TODO */}
                <iframe height="200px" width="100%" frameborder="no" scrolling="no" seamless src={latestEp}></iframe>
                <br/>
                <br/>
